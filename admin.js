...
coupon => {
  ...
  tr.innerHTML = `
    ...
    <td>
      <button
        class="small-button"
        data-edit-coupon="${escaparHtml(coupon.id)}"
        type="button"
      >
        ✏️
      </button>
      <button
        class="danger-button"
        data-delete-coupon="${escaparHtml(coupon.id)}"
        type="button"
      >
        🗑️
      </button>
  ...
  tbody
    .querySelector(
      `[data-edit-coupon="${CSS.escape(coupon.id)}"]`
    )
    ?.addEventListener(
      "click",
      () =>
  ...
  tbody
    .querySelector(
      `[data-delete-coupon="${CSS.escape(coupon.id)}"]`
    )
    ?.addEventListener(
      "click",
      () =>
...
offer => {
  ...
  tr.innerHTML = `
    ...
    <td>
      <button
        class="small-button"
        data-edit-offer="${escaparHtml(offer.id)}"
        type="button"
      >
        ✏️
      </button>
      <button
        class="danger-button"
        data-delete-offer="${escaparHtml(offer.id)}"
        type="button"
      >
        🗑️
      </button>
  ...
  tbody
    .querySelector(
      `[data-edit-offer="${CSS.escape(offer.id)}"]`
    )
    ?.addEventListener(
      "click",
      () =>
  ...
  tbody
    .querySelector(
      `[data-delete-offer="${CSS.escape(offer.id)}"]`
    )
    ?.addEventListener(
      "click",
      () =>
...
purchase => {
          ...
          ? `
            <div class="purchase-actions">
              <button
                ...
                data-approve="${escaparHtml(purchase.id)}"
                type="button"
              >
                ✅ APROBAR
              </button>
              <button
                class="danger-button"
                data-reject="${escaparHtml(purchase.id)}"
                type="button"
              >
                ❌ RECHAZAR
              </button>
  ...
  card
    .querySelector(
      `[data-approve="${CSS.escape(purchase.id)}"]`
    )
    ?.addEventListener(
      "click",
      () =>
  ...
  card
    .querySelector(
      `[data-reject="${CSS.escape(purchase.id)}"]`
    )
    ?.addEventListener(
      "click",
      () =>
